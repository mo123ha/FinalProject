...
<div className='my-8 '>
  <div className='row  gap-6  sm:justify-center items-center   md:justify-between'>
...
<i className='fas fa-spinner fa-spin  text-white text-5xl  text-center '></i>
  ...
  <div key={product._id} className=' sm:w-[48%]            md:w-[32%] border   border-gray-300 rounded-lg  hover:shadow-md hover:shadow-[#198754] '>
    <div >
