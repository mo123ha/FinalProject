...
<table       className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
  ...
  <tbody >
    <tr key={product._id} className="bg-gray-50 border-b  py-10  mb-0 flex justify-between items-center">
      <td className="p-4">
        <img src={product.imageCover} className="w-16 md:w-40 max-w-full max-h-full" alt="Apple Watch" />
      </td>
